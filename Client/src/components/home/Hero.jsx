...
const Hero = () => {
    ...
    return (
        <>
            ...
            <header className='bg-white text-black-700 flex flex-col items-center  bg-cover bg-center bg-no-repeat pb-10'>
    ...
    {user ? (
        <Link
            to="/app"
            className="hidden md:flex items-center justify-center bg-[#A6FF5D] text-gray-800 font-medium px-6 py-2.5 rounded-full text-sm hover:bg-green-500 transition"
        >
            Go to Dashboard
        </Link>
    ) : (
        <button className="hidden md:flex items-center gap-2 bg-[#A6FF5D] text-gray-800 font-medium px-4 py-2.5 rounded-full text-sm transition cursor-pointer group">
            ...
            <div className="relative overflow-hidden">
                <Link
                    ...
                    className="block transition-transform duration-200 group-hover:-translate-y-full"
                >
                    Get Started
                </Link>
    ...
    {user ? (
        <Link
            to="/app"
            className="bg-[#A6FF5D] hover:bg-green-600 text-gray-800 px-6 py-3 rounded-full text-sm transition"
        >
            Go to Dashboard
        </Link>
    ) : (
        <>
            ...
            <div className="bg-white/15 hover:bg-white/10 p-px flex items-center justify-center rounded-full hover:scale-105 transition duration-300">
                <Link
                    to="/login?state=login"
                    className="px-6 py-3 text-sm text-black rounded-full bg-[#A6FF5D] hover:bg-green-800"
                >
                    Login
                </Link>
            </div>
